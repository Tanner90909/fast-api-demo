...
class Hero(Base):
    ...
    def __repr__(self) -> str:
        return f"""Hero(id={self.id!r}, 
                name={self.name!r}, 
                about_me={self.about_me!r}, 
                biography={self.biography!r}, 
                image_url={self.image_url!r})"""
...
class Ability(Base):
    ...
    def __repr__(self) -> str:
        return f"""Ability(id={self.id!r}, 
                ability_type_id={self.ability_type_id!r}, 
                hero_id={self.hero_id!r})"""
